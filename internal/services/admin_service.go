...
func (s *AdminService) GetAllComplaints(page, limit int, search, status string) ([]models.Complaint, error) {
	return s.repo.GetAllComplaints(page, limit, search, status)
}
